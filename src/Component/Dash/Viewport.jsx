...
//           {/* Public URL display */}
//           <div className="mt-4 w-full max-w-xl text-sm bg-indigo-50 text-indigo-800 px-4 py-2 rounded shadow flex flex-col sm:flex-row sm:items-center gap-2">
//             <div className="flex items-center gap-2 truncate">
//               <FaLink />
//               <a href={`${window.location.origin}/view/${uid}`} target="_blank" rel="noreferrer" className="underline truncate">
//                 {`${window.location.origin}/view/${uid}`}
//               </a>
//             </div>
//             <button onClick={handleCopyLink} className="ml-auto text-indigo-600 hover:text-indigo-900 font-semibold">
//               {copySuccess ? <FaCheckCircle className="text-green-600" /> : "Copy"}
//             </button>
//           </div>
//         </section>
